...
import { RegistrationModal } from "../../location-information-terms-and-conditions/components/RegistrationModal";
import TermUseTableData from "./TermUseTableData";
...
const OrderingCompany = () => {
  ...
  const { OrderingCompanyHeader, OrderingCompanyTableData } = TermUseTableData({
  ...
  return (
    <div>
      <div className="mt-[10px]">
        <Table
          data={OrderingCompanyTableData}
          header={OrderingCompanyHeader}
          hasPagination={true}
          buttonLabel="등록"
